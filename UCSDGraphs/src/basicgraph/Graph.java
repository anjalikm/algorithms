...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int v = 0 ; v < numVertices; v++){
			degreeList.add(getNeighbors(v).size());
		}
	...
	public static void main (String[] args) {
		...
		List<Integer> dList = graphFromFile.degreeSequence();
		System.out.println("\nDegree Sequence:" + dList);
		System.out.println("Observe all degrees are <= 12.");
		System.out.println("****");

		System.out.println("\n****");
		List<Integer>n2list = graphFromFile.getDistance2(5);
		System.out.println("distance 2 neighbors from vertex 5 (adj list):" + n2list);
		
		
		GraphAdjMatrix graph2 = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", graph2);
		List<Integer>n2matrix = graphFromFile.getDistance2(5);
		System.out.println("distance 2 neighbors from vertex 5 (adj matrix):" + n2matrix);
